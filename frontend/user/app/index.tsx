import { Text, Image, View, Button, ImageBackground, StyleSheet } from 'react-native';
...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      <View style={{ alignItems: 'center', marginBottom: 10, marginTop: 10 }}></View>
      <Button title="Enter" color="#E64646" onPress={() => router.push('./login')} />
    </View>
